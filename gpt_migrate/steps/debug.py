...
def debug_error(error_message: str, relevant_files: str, globals: dict):
    """
    Debugs an error occurring during the code migration process.

    This function prompts the user to take actions based on the provided error message.
    The user can choose to move files, edit files, or create a new file to address the error.
    Additionally, the function can execute a provided shell script for debugging purposes.

    Args:
        error_message (str): The error message to debug.
        relevant_files (str): A comma-separated string of relevant files.
        globals (dict): A dictionary containing global variables.

    Raises:
        typer.Exit: If the debugging process requires human intervention.
...
def debug_testfile(error_message: str, testfile: str, globals: dict):
    """
    Debugs an error occurring in a test file during the code migration process.

    This function prompts the user to edit the test file based on the provided error message.
...
def require_human_intervention(error_message: str, relevant_files: str, globals: dict):
    """
    Requires human intervention to address an error during the code migration process.

    This function prompts the user to provide instructions for resolving the error.
